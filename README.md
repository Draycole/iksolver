...
A visual and interactive 2-DOF planar robot arm built with **Streamlit** and **Python**, featuring both:

-  **A deployed interactive web app**  
-  **A standalone local Python IK solver (CLI + Matplotlib)**
